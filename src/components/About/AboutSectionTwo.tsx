          ...
          <div className="w-full px-4">
            <div className="mx-auto max-w-4xl px-4">
              ...
              <p className="mx-auto max-w-3xl pb-10 text-left text-xl text-gray-600 md:text-2xl dark:text-gray-100">
                ...
                who most need it. By utilizing the therapeutic potential of
                melody and rhythm, we&#39;re creating connections, dismantling
                obstacles, and ensuring taht every child has the opportunities
                to flourish.
              </p>
              <p className="mx-auto max-w-3xl pb-10 text-left text-lg text-gray-600 md:text-2xl dark:text-gray-100">
              ...
              <p className="mx-auto max-w-3xl pb-10 text-left text-lg text-gray-600 md:text-2xl dark:text-gray-100">
                ...
                it was an effective instrument of connection and healing. The
                idea that music can be more than just sound; that it can be
                therapy, support, and hope for kids with autism, was the
                inspiration behind MU5IC4GOOD. Using music, our goal is to build
                a bridge to a brighter future.
              </p>
              <p className="mx-auto max-w-3xl text-left text-lg text-gray-600 md:text-2xl dark:text-gray-100">
                ...
                support. Everyone is more than welcome to attend and show their
                support for our performers and cause!
              </p>
            </div>
          </div>
        </div>
